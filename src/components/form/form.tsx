        ...
        <div className="pt-32 lg:pt-16 sx:pt-8">
          <div className="flex items-center justify-center pb-20 lg:pb-12 sx:pb-6">
            ...
            <input
              type="text"
              id="Tên"
              className=" rounded-none shadow-none appearance-none outline-none bg-white bg-opacity-05 py-3 w-96 border-white border-solid border-2 border-opacity-25 text-white px-3 sx:w-40 sx:h-7"
            />
          </div>
          <div className="flex items-center justify-center pb-20 lg:pb-12 sx:pb-6">
