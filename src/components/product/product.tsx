  ...
  return (
    <div className="h-screen box-border py-24 overflow-y-auto sx:py-6">
      <div className="max-w-screen-mxl mx-auto bg-black bg-opacity-02 h-full box-border px-24 flex items-center justify-center relative sx:px-4 sx:mx-4">
        ...
        >
          <SwiperSlide>
            <div className="flex flex-row justify-between items-center h-full cursor-pointer sx:flex-col sx:w-full w-full">
              <div className="pr-20 sx:order-2 sx:pr-0">
                <h2 className="text-5xl text-main sx:text-xl sx:text-center">Trạm sạc 8 ngăn</h2>
                <p className="text-2xl text-black text-opacity-25 pt-3 pb-16 border-black border-dotted border-opacity-75 border-b-2 lg:pb-6 sx:text-xs sx:text-center sx:pb-2 sx:border-none">
        ...
        <div className="child-swiper-pagination swiper-pagination w-full bottom-0 flex space-x-4 justify-center sx:bottom-4 pb-10"></div>
      </div>
    </div>
  );
}
