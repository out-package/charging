          ...
          <SwiperSlide>
            <div className="flex flex-row justify-between items-center h-full">
              <div className="pr-20">
                ...
                <p className="text-2xl text-black text-opacity-30 pt-3 pb-14 border-black border-dotted border-opacity-70 border-b-2 lg:pb-6">
                  Thiết kế nhỏ gọn, thích hợp cho cả không gian vừa và nhỏ
                </p>

                <div className="flex flex-row flex-wrap py-14 border-b-2 border-black border-solid border-opacity-10 lg:py-6">
                  <dl className="w-2/5 pb-16 lg:pb-8">
                ...
                <div className="pt-14 text-2xl lg:pt-8">
