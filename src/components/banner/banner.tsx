    ...
    <div className="h-screen mt-32 max-w-6xl relative mx-auto">
      <div className="h-screen relative z-20">
        <div className="pt-40">
          ...
          <p style={{ color: '#666' }} className=" max-w-xl text-3xl">Epin đang nỗ lực có mặt ở từng thành phố, trở thành nguồn pin di động tiện lợi và an toàn cho mọi người.</p>
        </div>
      </div>
      <img src="../../assets/images/banner.png" className="absolute right-0 top-0 bottom-0 z-10 -mr-40" alt="" />
    </div>
  );
}
